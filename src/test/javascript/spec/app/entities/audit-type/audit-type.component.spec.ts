...
import { AuditTypeComponent } from 'app/entities/audit-type/audit-type.component';
...
describe('Component Tests', () => {
  describe('AuditType Management Component', () => {
    let comp: AuditTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AuditTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.auditTypes && comp.auditTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

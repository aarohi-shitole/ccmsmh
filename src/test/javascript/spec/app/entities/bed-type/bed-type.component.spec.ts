...
import { BedTypeComponent } from 'app/entities/bed-type/bed-type.component';
import { BedTypeService } from 'app/entities/bed-type/bed-type.service';
import { BedType } from 'app/shared/model/bed-type.model';

describe('Component Tests', () => {
  describe('BedType Management Component', () => {
    let comp: BedTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BedTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bedTypes && comp.bedTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

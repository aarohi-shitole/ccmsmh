...
import { InventoryMasterComponent } from 'app/entities/inventory-master/inventory-master.component';
...
describe('Component Tests', () => {
  describe('InventoryMaster Management Component', () => {
    let comp: InventoryMasterComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InventoryMasterComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.inventoryMasters && comp.inventoryMasters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

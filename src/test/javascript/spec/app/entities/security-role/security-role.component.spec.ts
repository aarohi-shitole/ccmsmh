...
import { SecurityRoleComponent } from 'app/entities/security-role/security-role.component';
...
describe('Component Tests', () => {
  describe('SecurityRole Management Component', () => {
    let comp: SecurityRoleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SecurityRoleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.securityRoles && comp.securityRoles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

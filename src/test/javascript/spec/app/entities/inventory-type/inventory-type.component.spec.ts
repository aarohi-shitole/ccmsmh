...
import { InventoryTypeComponent } from 'app/entities/inventory-type/inventory-type.component';
...
describe('Component Tests', () => {
  describe('InventoryType Management Component', () => {
    let comp: InventoryTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InventoryTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.inventoryTypes && comp.inventoryTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

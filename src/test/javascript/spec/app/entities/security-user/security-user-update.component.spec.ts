...
import { SecurityUserUpdateComponent } from 'app/entities/security-user/security-user-update.component';
  ...
  describe('SecurityUser Management Update Component', () => {
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', fakeAsync(() => {
        // GIVEN
        const entity = new SecurityUser(123);

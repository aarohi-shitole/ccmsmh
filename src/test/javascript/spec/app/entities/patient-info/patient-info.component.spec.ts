...
import { PatientInfoComponent } from 'app/entities/patient-info/patient-info.component';
...
describe('Component Tests', () => {
  describe('PatientInfo Management Component', () => {
    let comp: PatientInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PatientInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.patientInfos && comp.patientInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

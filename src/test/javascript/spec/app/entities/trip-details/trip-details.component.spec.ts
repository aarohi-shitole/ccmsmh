...
import { TripDetailsComponent } from 'app/entities/trip-details/trip-details.component';
...
describe('Component Tests', () => {
  describe('TripDetails Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TripDetailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tripDetails && comp.tripDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

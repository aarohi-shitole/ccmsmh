...
import { UserAccessComponent } from 'app/entities/user-access/user-access.component';
...
describe('Component Tests', () => {
  describe('UserAccess Management Component', () => {
    let comp: UserAccessComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserAccessComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userAccesses && comp.userAccesses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

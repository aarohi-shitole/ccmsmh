...
import { SecurityPermissionComponent } from 'app/entities/security-permission/security-permission.component';
  ...
  describe('SecurityPermission Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new SecurityPermission(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.securityPermissions && comp.securityPermissions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

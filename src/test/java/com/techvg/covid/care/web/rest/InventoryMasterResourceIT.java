...
@WithMockUser
public class InventoryMasterResourceIT {
    ...
    @Autowired
    private InventoryMasterQueryService inventoryMasterQueryService;
    ...
    @Test
    @Transactional
    public void createInventoryMaster() throws Exception {
        ...
        restInventoryMasterMockMvc.perform(post("/api/inventory-masters")
        ...
        assertThat(testInventoryMaster.isDeleted()).isEqualTo(DEFAULT_DELETED);
    ...
    @Test
    @Transactional
    public void createInventoryMasterWithExistingId() throws Exception {
        int databaseSizeBeforeCreate = inventoryMasterRepository.findAll().size();
    ...
    @Test
    @Transactional
    public void getAllInventoryMasters() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);

        // Get all the inventoryMasterList
        restInventoryMasterMockMvc.perform(get("/api/inventory-masters?sort=id,desc"))
    ...
    @Test
    @Transactional
    public void getInventoryMaster() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);

        // Get the inventoryMaster
        restInventoryMasterMockMvc.perform(get("/api/inventory-masters/{id}", inventoryMaster.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    @Test
    @Transactional
    public void getInventoryMastersByIdFiltering() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByNameIsEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByNameIsInShouldWork() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByNameIsNullOrNotNull() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
        ...
        defaultInventoryMasterShouldNotBeFound("name.specified=false");
                ...
                @Test
    @Transactional
    public void getAllInventoryMastersByNameContainsSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByNameNotContainsSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDescriptionIsEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDescriptionIsNotEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDescriptionIsInShouldWork() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDescriptionIsNullOrNotNull() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
        ...
        defaultInventoryMasterShouldNotBeFound("description.specified=false");
                ...
                @Test
    @Transactional
    public void getAllInventoryMastersByDescriptionContainsSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDescriptionNotContainsSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByVolumeIsEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByVolumeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByVolumeIsInShouldWork() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByVolumeIsNullOrNotNull() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByVolumeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByVolumeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByVolumeIsLessThanSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByVolumeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByUnitIsEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByUnitIsNotEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByUnitIsInShouldWork() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByUnitIsNullOrNotNull() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
        ...
        defaultInventoryMasterShouldNotBeFound("unit.specified=false");
                ...
                @Test
    @Transactional
    public void getAllInventoryMastersByUnitContainsSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByUnitNotContainsSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByCalulateVolumeIsEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByCalulateVolumeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByCalulateVolumeIsInShouldWork() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByCalulateVolumeIsNullOrNotNull() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByCalulateVolumeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByCalulateVolumeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByCalulateVolumeIsLessThanSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByCalulateVolumeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDimensionsIsEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDimensionsIsNotEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDimensionsIsInShouldWork() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDimensionsIsNullOrNotNull() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
        ...
        defaultInventoryMasterShouldNotBeFound("dimensions.specified=false");
                ...
                @Test
    @Transactional
    public void getAllInventoryMastersByDimensionsContainsSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDimensionsNotContainsSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersBySubTypeIndIsEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersBySubTypeIndIsNotEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersBySubTypeIndIsInShouldWork() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersBySubTypeIndIsNullOrNotNull() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
        ...
        defaultInventoryMasterShouldNotBeFound("subTypeInd.specified=false");
                ...
                @Test
    @Transactional
    public void getAllInventoryMastersBySubTypeIndContainsSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersBySubTypeIndNotContainsSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDeletedIsEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDeletedIsNotEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDeletedIsInShouldWork() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByDeletedIsNullOrNotNull() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByLastModifiedIsEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByLastModifiedIsNotEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByLastModifiedIsInShouldWork() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByLastModifiedIsNullOrNotNull() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByLastModifiedByIsEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByLastModifiedByIsNotEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByLastModifiedByIsInShouldWork() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByLastModifiedByIsNullOrNotNull() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
        ...
        defaultInventoryMasterShouldNotBeFound("lastModifiedBy.specified=false");
                ...
                @Test
    @Transactional
    public void getAllInventoryMastersByLastModifiedByContainsSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByLastModifiedByNotContainsSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
    ...
    @Test
    @Transactional
    public void getAllInventoryMastersByInventoryTypeIsEqualToSomething() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
        InventoryType inventoryType = InventoryTypeResourceIT.createEntity(em);
    ...
    private void defaultInventoryMasterShouldBeFound(String filter) throws Exception {
        restInventoryMasterMockMvc.perform(get("/api/inventory-masters?sort=id,desc&" + filter))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(inventoryMaster.getId().intValue())))
            .andExpect(jsonPath("$.[*].name").value(hasItem(DEFAULT_NAME)))
        ...
        restInventoryMasterMockMvc.perform(get("/api/inventory-masters/count?sort=id,desc&" + filter))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    @Test
    @Transactional
    public void getNonExistingInventoryMaster() throws Exception {
        // Get the inventoryMaster
        restInventoryMasterMockMvc.perform(get("/api/inventory-masters/{id}", Long.MAX_VALUE))
            .andExpect(status().isNotFound());
    }

    @Test
    @Transactional
    public void updateInventoryMaster() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
        ...
        restInventoryMasterMockMvc.perform(put("/api/inventory-masters")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(inventoryMasterDTO)))
            .andExpect(status().isOk());
        ...
        assertThat(testInventoryMaster.isDeleted()).isEqualTo(UPDATED_DELETED);
    ...
    @Test
    @Transactional
    public void updateNonExistingInventoryMaster() throws Exception {
        int databaseSizeBeforeUpdate = inventoryMasterRepository.findAll().size();
    ...
    @Test
    @Transactional
    public void deleteInventoryMaster() throws Exception {
        // Initialize the database
        inventoryMasterRepository.saveAndFlush(inventoryMaster);
        ...
        restInventoryMasterMockMvc.perform(delete("/api/inventory-masters/{id}", inventoryMaster.getId())

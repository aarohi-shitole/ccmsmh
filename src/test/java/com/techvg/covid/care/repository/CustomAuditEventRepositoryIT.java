...
import com.techvg.covid.care.config.audit.AuditEventConverter;
import com.techvg.covid.care.domain.PersistentAuditEvent;
...
import static com.techvg.covid.care.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

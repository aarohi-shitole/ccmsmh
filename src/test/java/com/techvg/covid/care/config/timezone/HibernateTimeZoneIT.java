package com.techvg.covid.care.config.timezone;

import com.techvg.covid.care.CovidCareApp;
import com.techvg.covid.care.repository.timezone.DateTimeWrapper;
import com.techvg.covid.care.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM tvg_date_time_wrapper where id=%d", fieldName, id);
    }

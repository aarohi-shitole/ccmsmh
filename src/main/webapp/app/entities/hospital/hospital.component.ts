...
export class HospitalComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.hospitalService
      ...
      .subscribe(
        (res: HttpResponse<IHospital[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IHospital[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

...
export class TripComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.tripService
      ...
      .subscribe(
        (res: HttpResponse<ITrip[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ITrip[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

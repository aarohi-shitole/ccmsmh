...
export class InventoryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.inventoryService
      ...
      .subscribe(
        (res: HttpResponse<IInventory[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInInventories(): void {
    this.eventSubscriber = this.eventManager.subscribe('inventoryListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IInventory[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

...
@Component({
  selector: 'tvg-security-permission',
  templateUrl: './security-permission.component.html',
})
export class SecurityPermissionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.securityPermissionService
      ...
      .subscribe(
        (res: HttpResponse<ISecurityPermission[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  ngOnInit(): void {
    ...
    this.registerChangeInSecurityPermissions();
  }
  ...
  trackId(index: number, item: ISecurityPermission): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInSecurityPermissions(): void {
    this.eventSubscriber = this.eventManager.subscribe('securityPermissionListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ISecurityPermission[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/security-permission'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,

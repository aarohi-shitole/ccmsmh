...
export class ContactTypeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.contactTypeService
      ...
      .subscribe(
        (res: HttpResponse<IContactType[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInContactTypes(): void {
    this.eventSubscriber = this.eventManager.subscribe('contactTypeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IContactType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

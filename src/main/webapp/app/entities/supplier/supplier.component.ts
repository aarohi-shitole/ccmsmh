...
export class SupplierComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.supplierService
      ...
      .subscribe(
        (res: HttpResponse<ISupplier[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSuppliers(): void {
    this.eventSubscriber = this.eventManager.subscribe('supplierListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ISupplier[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

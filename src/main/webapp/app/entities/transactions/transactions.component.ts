...
export class TransactionsComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.transactionsService
      ...
      .subscribe(
        (res: HttpResponse<ITransactions[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInTransactions(): void {
    this.eventSubscriber = this.eventManager.subscribe('transactionsListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITransactions[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

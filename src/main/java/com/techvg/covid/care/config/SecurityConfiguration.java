...
import com.techvg.covid.care.security.*;
import com.techvg.covid.care.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTH_WHITELIST = {
        ...
        "/api/bed-inventories/**",
        "/api/account",
        "/api/authenticateBackend"
        // other public endpoints of API to be appended to this array
    };
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors()
            ...
            .antMatchers("/api/authenticateBackend").permitAll()
            .antMatchers("/api/authenticateweb").permitAll()
            .antMatchers("/api/authenticateBackendWeb").permitAll()
            .antMatchers("/api/isAuthenticated").permitAll()

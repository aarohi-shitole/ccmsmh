...
public class LoginUserDTO implements Serializable {
	...
	public String toString() {
		return "LoginUserDTO [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", login=" + login
				+ ", email=" + email + ", imageUrl=" + imageUrl + ", langKey=" + langKey + ", resetDate=" + resetDate
				+ ", mobileNo=" + mobileNo + ", authorities=" + authorities + ", userAccess=" + userAccess + "]";
	}

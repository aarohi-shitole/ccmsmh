...
public class ContactTypeResource {
    ...
    public ResponseEntity<ContactTypeDTO> updateContactType(@Valid @RequestBody ContactTypeDTO contactTypeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, contactTypeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<ContactTypeDTO>> getAllContactTypes(ContactTypeCriteria criteria, Pageable pageable) {
